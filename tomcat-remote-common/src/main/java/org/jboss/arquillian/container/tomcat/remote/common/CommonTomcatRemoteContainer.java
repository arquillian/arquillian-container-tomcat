 ...
 * @version $Revision: $
 */
public class CommonTomcatRemoteContainer implements DeployableContainer<TomcatRemoteConfiguration>
{
   ...
   public CommonTomcatRemoteContainer(final ProtocolDescription protocolDescription,
   ...
   public void setup(final TomcatRemoteConfiguration configuration)
   {
      ...
      this.manager = new CommonTomcatManager<TomcatRemoteConfiguration>(configuration, tomcatManagerCommandSpec);
   }
