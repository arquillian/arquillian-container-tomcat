 ...
 */
public class Tomcat10EmbeddedContainer implements DeployableContainer<TomcatEmbeddedConfiguration> {
    ...
    private File getTomcatHomeFile() throws LifecycleException {
        ...
        if (tomcatHome != null) {
            ...
            try {
                tomcatHomeFile = File.createTempFile("tomcat-embedded-10", null);
