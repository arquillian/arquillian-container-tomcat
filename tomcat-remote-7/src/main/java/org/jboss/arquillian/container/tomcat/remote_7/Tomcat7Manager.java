...
/**
 * Tomcat 7 <em>Manager</em> client for dynamically deploying and undeploying applications.
 *
 * @author jbush
 */
public class Tomcat7Manager extends CommonTomcatManager<CommonTomcatConfiguration>
{
